...
import com.nexusforge.grpcplayground.models.sec07.RequestSize;
...
public class FlowControlService extends FlowControlServieGrpc.FlowControlServieImplBase {
    ...
    private static class RequestHandler implements StreamObserver<RequestSize> {
        ...
        private Integer emitted; // to keep track of messages emitted so far.
